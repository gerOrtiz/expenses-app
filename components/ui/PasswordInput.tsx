...
import { FieldErrors, FieldValues, RegisterOptions, useFormContext } from "react-hook-form";
...
const PasswordInput: React.FC<PasswordProps<SignupCredentials>> = ({ name, options, errors, label }) => {
