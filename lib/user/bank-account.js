...
import { getAccount, setAccount, setIncomes, setRemaining } from "@/services/account-movements.service";
...
export async function updateIncomeList(incomeList, account) {
  if (!Array.isArray) throw new Error('Error: No se envío la lista de ingresos');
